    ...
    {  
     ...
     {    
        if(p->data_counter1==0)
          fp1=fopen("/home/lctuan/result_LoOP/training1.log","r");
        ...
        { 
          ...
          for(int i=0;i<p->data_counter1;i++)
          {
           p->Data1[i]->LoOP = LoOP(p->Data1[i],p->Data1,p->data_counter1);
      ...
      else 
      {
         ...
         p->loOP_status1 = LoOP_udate(p->state1,p->Data1,p->data_counter1);
     ...
     {    
        ...
        { 
          ...
          for(int i=0;i<p->data_counter2;i++)
          {
           ...
           p->Data2[i]->LoOP = LoOP(p->Data2[i],p->Data2,p->data_counter2);
      ...
      else 
      {
         ...
         p->loOP_status2 = LoOP_udate(p->state2,p->Data2,p->data_counter2);
    ...
    {  
     ...
     {    
        ...
        { 
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data3[i]->LoOP = LoOP(p->Data3[i],p->Data3,p->data_counter3);
      ...
      else 
      {
         ...
         p->loOP_status3 = LoOP_udate(p->state3,p->Data3,p->data_counter3);
    ...
    {  
     ...
     {    
        ...
        { 
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data4[i]->LoOP = LoOP(p->Data4[i],p->Data4,p->data_counter4);
      ...
      else 
      {
         ...
         p->loOP_status4 = LoOP_udate(p->state4,p->Data4,p->data_counter4);
    ...
    {  
     ...
     {    
        ...
        { 
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data5[i]->LoOP = LoOP(p->Data5[i],p->Data5,p->data_counter5);
      ...
      else 
      {
         ...
         p->loOP_status5 = LoOP_udate(p->state5,p->Data5,p->data_counter5);
    ...
    {  
     ...
     {    
        ...
        { 
          ...
          {
           // temp=1.0*calc_LOF(p->Data,p->data_counter,p->Data[i]);
           p->Data6[i]->LoOP = LoOP(p->Data6[i],p->Data6,p->data_counter6);
      ...
      else 
      {
         ...
         p->loOP_status6 = LoOP_udate(p->state6,p->Data6,p->data_counter6);
...
ofproto_run(struct ofproto *p)
{
    ...
    else if (p->datapath_id == 0000000000000002)
    {
        abnormal_detect2(p);
    }
    else if (p->datapath_id == 0000000000000003)
    {
        abnormal_detect3(p);
    }
    else if (p->datapath_id == 0000000000000004)
    {
        abnormal_detect4(p);
    }
    else if (p->datapath_id == 0000000000000005)
    {
        abnormal_detect5(p);
    }
    else if (p->datapath_id == 0000000000000006)
    {
        abnormal_detect6(p);
    }
    //trigger_send_anomaly_detection(p);    
